...
public class MemberDAO {
	...
	public void create(MemberDTO dto) {
		System.out.println(dto.getId()+":아이디를 생성했습니다");
		db.add(dto);
		}
	public void update(MemberDTO dto) {
		System.out.println(dto.getId()+":아이디를 수정했습니다");
		db.set(db.indexOf(dto),dto);
	}
	public void delete(MemberDTO dto) {
		System.out.println(dto.getId()+":아이디를 삭제했습니다");
	...
	public boolean idPattern(String id) {
		return Pattern.matches("^[a-zA-Z0-9]*$", id)?true:false;
	}
}
